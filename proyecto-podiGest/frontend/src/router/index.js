...
import HistorialCitasEspecialista from '../views/HistorialCitasEspecialista.vue'
...
const routes = [
    ...
    {
        path: '/historial-citas-especialista',
        name: 'historial-citas-especialista',
        component: HistorialCitasEspecialista
    },
    {
        path: '/cancelar-citas',
        name: 'cancelar-citas',
